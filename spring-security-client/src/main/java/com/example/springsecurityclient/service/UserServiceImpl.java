...
public class UserServiceImpl implements UserService{
    ...
    public String validateVerificationToken(String token) {
        VerificationToken verificationToken = verificationTokeRepository.findByToken(token);
        ...
        if (verificationToken.getExpirationTime().getTime()
            ...
            verificationTokeRepository.delete(verificationToken);
            return "expired";
        }
    ...
    public VerificationToken generateNewVerificationToken(String oldToken) {
        VerificationToken verificationToken = verificationTokeRepository.findByToken(oldToken);
